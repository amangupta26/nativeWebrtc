...
class FirstPageContainer extends React.Component{
	...
	callPeer(){
		...
		pc1.createOffer(offerOptions).then(function(offerDesc){
			pc1.setLocalDescription(offerDesc).then(function(){}, function(err1){console.log("err1 ", err1)});
			pc2.setRemoteDescription(offerDesc).then(function(){}, function(err1){console.log("err2 ", err2)});

			pc2.createAnswer().then(function(answerDesc){
				pc2.setLocalDescription(answerDesc).then(function(){}, function(err1){console.log("err3 ", err3)});
				pc1.setRemoteDescription(answerDesc).then(function(){}, function(err1){console.log("err4 ", err4)});
			});
		});
	}
